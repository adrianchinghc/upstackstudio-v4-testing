...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Privacy Policy | Upstack Studio',
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-3xl">
        ...
        <AnimatedSection delay={0.1}>
          <div className="prose prose-lg max-w-none text-secondary">
            <p>
              Upstack Studio Sdn Bhd (&quot;Upstack Studio&quot;, &quot;we&quot;, &quot;us&quot;, or
              ...
              website upstackstudio.com or engage with our services.
            </p>
            ...
            <p>
              This information may include your name, email address, phone number, company name, job
              title, and any other information you choose to provide about your project
              requirements.
            </p>
            ...
            <ul>
              <li>
                ...
                (e.g., hosting providers, CRM systems, analytics tools)
              </li>
              <li>
                <strong>Professional advisors:</strong> Lawyers, accountants, and other advisors as
                needed
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                <strong>HubSpot:</strong> For customer relationship management and form submissions
              </li>
              <li>
                <strong>Calendly:</strong> For scheduling strategy sessions
              </li>
              <li>
            ...
            <p>
              Each of these services has their own privacy policy governing how they handle your
              data.
            </p>
            ...
            <p>
              ...
              For client engagements, we retain project-related information for at least 7 years for
            ...
            <p>
              ...
              <a href="mailto:hello@upstackstudio.com">hello@upstackstudio.com</a>.
            </p>
            ...
            <p>
              ...
              including countries where our service providers operate. We ensure appropriate
            ...
            <p>
              <strong>Upstack Studio Sdn Bhd</strong>
              <br />
              Email: <a href="mailto:hello@upstackstudio.com">hello@upstackstudio.com</a>
              <br />
