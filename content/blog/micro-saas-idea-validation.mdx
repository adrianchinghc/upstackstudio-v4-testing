...
Buffer used [**a landing page that explain key features and pricing**](https://buffer.com/resources/content/images/4dlU/Buffer-MVP-2.png)_._
...
If you address a real pain point and present a viable solution, _it will attract attention._
...
_Hey there stranger, thanks for reading all the way to the end. Consider joining our mailing list for a one-stop resource on everything from micro SaaS validation all the way to execution and promotion._ _Get a nifty list of questions to ask [app developers](https://upstackstudio.com/)when you sign up!_
