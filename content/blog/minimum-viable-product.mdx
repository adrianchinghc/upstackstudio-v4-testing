...
**This video got over 70,000 people to sign up overnight**because they understood the idea and went "_Yep, we want it._"
...
Eric Ries, the author of _"The Lean Startup"_, [**defined the meaning of MVP**](http://www.startuplessonslearned.com/2009/08/minimum-viable-product-guide.html) as "_That version of a new product which allows a team to collect the maximum amount of validated learning about customers with the least effort."_
...
Let’s say your app idea _is_ a mistake (there’s*no *shame in that - most app ideas fail).
...
Being seen by users as the "first" to do something is priceless marketing that you can leverage _forever_.
...
_(This is what we actually do with our clients when we sit down with them and conduct a [**product roadmapping workshop**](https://upstackstudio.com/roadmap/), which you're most welcome to sign up for)._
