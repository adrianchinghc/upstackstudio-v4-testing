...
_“But wait,” you say, “What about insert whatever backend tool you’ve heard of”._
...
[**Zapier**](https://zapier.com/) is the SaaS version of that guy who knows everyone and is always down to introduce you to new business connections -_ for a price!_
...
You have some leeway here; the point is to include _some_ kind of integration tool in your tech stack.
...
That is a _hell_ of a stack, and anyone who takes the time to learn how to fully utilize those platforms will be capable of building a very complex app.
...
- \*_If you want custom user authentication and custom_ whatever else*that you can’t build yourself, *then\*you add on Zapier
